  ...
  models: {
    ...
    cobalt: {
      ...
      model: {
        position: [
          [0, -6.0,  -0.3],    // KF0
          [0, -6.0,  -0.3],    // KF1 — sube la caja, bolsa queda abajo
          [0, -6.0,  -0.3],    // KF2
          [0, -6.0,  -0.3],    // KF3 — caja abierta alrededor de la bolsa
          [0, -6.0,  -0.3],     // KF4
          [0, -8.0,  -0.3],     // KF5 — empieza a bajar
          [0, -23.0,  -0.3],    // KF6
          [0, -33.0,  -0.3],    // KF7
        ],
        rotation: [
          ...
          [0, 0, 0],               // KF0 → 0°
          [-Math.PI / 6,0,  Math.PI * 0.25, ],     // KF1 → 30°
          [-Math.PI / 3,0,  Math.PI * 0.5, ],     // KF2 → 60°
          [-Math.PI / 2,0, Math.PI * 0.75, ],     // KF3 → 90°
          [-Math.PI / 2,0, Math.PI * 0.75, ],     // KF4
          [-Math.PI / 2,0, Math.PI * 0.75, ],     // KF5
          [-Math.PI / 2,0, Math.PI * 0.75, ],     // KF6
          [-Math.PI / 2,0, Math.PI * 0.75, ],     // KF7
            // KF7
        ],
        //        KF0   KF1   KF2   KF3   KF4   KF5   KF6   KF7
        scale: [  3.2,  3.2,  3.2,  2.5,  2.5,  2.5,  2.5,  2.5 ],
      },
